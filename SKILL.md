...
文字怎么写见 @references/writing-style.md。其中四条最容易做错，先记住：

- **讲透"为什么这么做"而不只是"做了什么"** —— 页面的价值全在后者
- **只解释真正会拦住读者的名词**，望文生义的词一个都不要解释
- **末尾不许加总结章**
- **别用力过猛** —— 每条规则都有过头的方向：标题躲开名词短语后容易滑向抖机灵和戏剧腔，类比多了会喧宾夺主，列表满页就没有连贯叙述了。读者要的是把事讲明白，不是欣赏文笔
